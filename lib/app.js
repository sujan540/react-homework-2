...
var AddUser = function (_Component) {
  ...
  function AddUser() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(AddUser).apply(this, arguments));
  }

  _createClass(AddUser, [{
    key: 'handleUser',
    value: function handleUser(data) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          { onSubmit: self.handleUser },
          _react2.default.createElement('input', _extends({ type: 'text' }, name, { placeholder: 'name' })),
          _react2.default.createElement(
            'button',
            { onSubmit: self.handleUser },
            'Add User'
...
exports.default = (0, _reduxForm.reduxForm)(reduxFormConfig, mapStateToProps)(AddUser);
